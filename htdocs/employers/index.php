...
<head>
	...
	<title>Εργοδότες - Υπουργείο Εργασίας &amp; Κοινωνικών Υποθέσεων</title>
...
<div class="undermenuarea">
	...
	<div class="grid">
		<div class="row">
			<div class="c8">
				<h1 class="titlehead">Υπηρεσίες προς Εργοδότες</h1>
			</div>
		</div>
	</div>
</div>
			...
			<div class="boxthreecolumns cat1 cat3">
				<div class="boxcontainer">
					...
					<div class="mosaic-block cover mosaicover4col">
						...
						<div class="details">
							<p>
								Ενημερωθείτε για το νομικό πλαίσιο γύρω από την εργασία, καθώς και για τα δικαιώματά και τις υποχρεώσεις των εργοδοτών.
							</p>
							<i class="icon-cog mosaiclink"></i>
						</div>
						</div>
			...
			<div class="boxthreecolumns cat1">
				<div class="boxcontainer">
					...
					<div class="mosaic-block cover mosaicover4col">
						...
						<div class="details">
							<p>
								Το Υπουργείο παρέχει προγράμματα επιχορήγησης επιχειρήσεων με σκοπό τη μείωση της ανεργίας και την ανάπτυξη του επιχειρισιακού τομέα.
							</p>
							<i class="icon-cog mosaiclink"></i>
						</div>
						</div>
